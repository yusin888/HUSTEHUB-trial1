...
(1, 'HustleHub-ADMIN', 'hustlehubjuja343@gmail.com', '0740674466', 'adminhustle11');
...
(4, 'Esther Ngungi', 'amesther_002', 'esther.fav@gmail.com', '0711322909', 'Female', 'esther@11', 'esther@11'),
(5, 'Ivy Muthono', 'muthoniivy', 'ivy303muthoni@gmail.com', '0744235675', 'Female', '90911', '90911'),
...
(2, 'Ali Adan Yunus', 'Client', 'yusin888@gmail.com', 'Nice...not bad'),
(3, 'Ivy Muthono', 'Client', 'ivy303muthoni@gmail.com', 'Really loved your services especially the laundry ');
...
(3, 1, 'Ali Adan Yunus', '0723456743', 'I lived at gate C near containers', 'I wish to shift to Gate A near green savanah;bedsitter 2nd floor', 22, 'Kevin Irungu', '0721090887', 'Not complete', 'Mover', 'Your charges were very high and not negotiable'),
(4, 5, 'Ivy Muthono', '0744235675', 'Living at Gashororo at Gate B', 'Got clothes in 3 big bags which includes a duvet', 18, 'Zeinab Memusa', '0734566090', 'Not complete', 'Laundry', 'none'),
...
CREATE TABLE `technicians` (
  ...
  `jobdescription` varchar(500) DEFAULT 'Not added yet...',
  `password` varchar(50) NOT NULL,
  `gender` varchar(50) NOT NULL,
  `ratings` decimal(10,3) DEFAULT 4.000,
  `image_location` varchar(255) DEFAULT '../images/usr_service-removebg-preview.png',
...
(1, 'Eric Kazungu', 'kazungu233', 'eric.kahindi233@gmail.com', '0734567333', '32217109', 'uploaded', 'Plumber', 'Your plumbing problems solved. From installations and repairs to maintenance and troubleshooting, I\'m your one-stop shop for all your plumbing and water needs.', 'eric233', 'Male', 4.100, '../Plumbers/Plumbers/plumber1.png', 'Available'),
(2, 'Abdirahman Green', 'greenabdi11', 'abdirahman.carp@outlook.com', '0720344909', '11225567', 'uploaded', 'Carpenter', 'Your dedicated carpentry ready to transform your ideas into masterful craftsmen, with over 5 years of hands-on experience in carpentry...', 'green09', 'Male', 4.000, '../images/dude_carpenter.png', 'Available'),
...
(4, 'John Smith Rowe', 'smithjohn', 'smith.john40@gmail.com', '0725686544', '39900212', 'uploaded', 'Carpenter', 'Skilled carpenter with attention to detail and a passion for delivering high-quality work.with over 5 years of hands-on experience in carpentry.', 'smith211', 'Male', 4.500, '../images/carpenter_stand.png', 'Available'),
(5, 'Sarah Johnson', 'amsarah', 'johnson.sarah.john@gmail.com', '0735767211', '11225532', 'uploaded', 'Carpenter', 'Creative carpenter known for innovative designs and flawless execution.with over 3 years of hands-on experience in carpentry', 'sara11', 'Female', 4.200, '../images/female_carpenter-.png', 'Available'),
...
(7, 'Yunus Abdi', 'abdiyu55', 'yunus.abdi.abduba@gmail.com', '0723775677', '30311222', 'uploaded', 'Plumber', 'Leaking faucet? Clogged drain? No problem! I\'m your friendly neighborhood plumber, ready to tackle any residential or commercial plumbing issue, big or small.', 'abdi55', 'Male', 4.100, '../Plumbers/Plumbers/plumber2.png', 'Available'),
...
(9, 'Esmail Obo', 'obo_fundi', 'oboEsmail@gmail.com', '0735889722', '3110091', 'uploaded', 'Plumber', 'We keep the water flowing, so you don\'t have to stress. From leaky pipes to drain cleaning, we handle all your plumbing needs efficiently and professionally.', 'obo_f_10', 'Male', 3.800, '../Plumbers/Plumbers/plumber4.png', 'Available'),
...
(15, 'Samwell Bett', 'bett.betika', 'sam.samwell@yahoo.com', '0741879988', '33771101', 'uploaded', 'Electrician', 'Reliable Electrician offering personalized services tailored to your needs.I\'m your one-stop shop for all your electrical needs.Just one phone call away', 'sam_bet_676', 'Male', 3.900, '../Electricians/electrician.png', 'Available'),
...
(18, 'Zeinab Memusa', 'musa_zena', 'zeinab.memusa@students.jkuat.ac.ke', '0734566090', '23390911', 'uploaded', 'Laundry', 'Say goodbye to laundry day. I\'m your convenient and affordable solution for all your laundry needs, from delicates to bulky items.Bringing back your clothes similar to new clothes right from the shop', 'zena45', 'Female', 4.100, '../Laundry/Laundry/laundry_female_better.png', 'Available'),
...
(21, 'Isaan Kariithi', 'kariithi909', 'kariithi.nyoor0@gmail.com', '0745676322', '23345090', 'uploaded', 'Mover', 'Moving made easy. From packing and loading to transport and unloading, we handle everything with care and expertise.With specialized designers who would help you arrange your newly shifted items in a design you would love ', 'kairiithi.jayden', 'Male', 4.230, '../Movers/Movers/mover2.png', 'Available'),
(22, 'Kevin Irungu', 'irungu_mungai', 'irungu.kevin@yahoo.com', '0721090887', '21109088', 'uploaded', 'Mover', 'Your trusted moving partner. We\'re experienced and insured movers who prioritize your satisfaction and ensure your belongings arrive safely.', 'irungu_mungai33', 'Male', 3.550, '../Movers/Movers/mover3.png', 'Available');
...
--
ALTER TABLE `approvals`
  MODIFY `approvalid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `technicians`
  MODIFY `technicianid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
